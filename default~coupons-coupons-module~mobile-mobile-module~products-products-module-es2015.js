...
class NgbModalWindow {
    ...
    constructor(_document, _elRef, _zone) {
         ...
         */
        () => {
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this._elRef.nativeElement, 'keydown')
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.dismissEvent), 
            // tslint:disable-next-line:deprecation
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])((/**
             * @param {?} e
             * @return {?}
            ...
            /** @type {?} */
            const mouseDowns$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this._elRef.nativeElement, 'mousedown')
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.dismissEvent), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((/**
             * @param {?} e
             * @return {?}
             */
            e => this.backdrop === true && this._elRef.nativeElement === e.target)));
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEvent"])(this._elRef.nativeElement, 'mouseup')
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.dismissEvent), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["withLatestFrom"])(mouseDowns$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])((/**
             * @param {?} __0
             * @return {?}
             */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "imageBaseUrl", function() { return imageBaseUrl; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");

// let ip = "192.168.10.12";
let ip = "199.188.206.178";
let baseUrl = "http://" + ip + ":8000/";
let imageBaseUrl = "http://" + ip + ":8000";
...
let ProductService = class ProductService {
    ...
    getMethod(successCallBack, errorCallBack, options, endPoint) {
        let x = {};
        let queryParameter = '';
        let keysList = Object.keys(options);
        ...
        this.http.get(_Models_common__WEBPACK_IMPORTED_MODULE_3__["baseUrl"] + endPoint + '?' + queryParameter).subscribe((response) => {
            console.log(">>>>>");
    ...
    postMethod(successCallBack, errorCallback, body, url) {
        this.http.post(_Models_common__WEBPACK_IMPORTED_MODULE_3__["baseUrl"] + url, body).subscribe((response) => {
            successCallBack(response);
        }, (error) => {
            errorCallback(error);
        });
    }
    deleteMethod(successCallBack, errorCallback, body, url) {
        console.log(body);
        const httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ 'Content-Type': 'application/json' }), body: body
        };
        this.http.delete(_Models_common__WEBPACK_IMPORTED_MODULE_3__["baseUrl"] + url, httpOptions).subscribe((response) => {
            successCallBack(response);
        }, (error) => {
            errorCallback(error);
        });
